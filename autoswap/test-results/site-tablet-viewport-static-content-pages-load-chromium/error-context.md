...
- Name: site.spec.ts >> tablet viewport >> static content pages load
...
- generic [ref=e2]:
  ...
  - main [ref=e19]:
    - region [ref=e20]:
      - generic [ref=e21]:
        - heading "გაცვალე მანქანა გაყიდვის გარეშე" [level=1] [ref=e22]
        - paragraph [ref=e23]: AutoSwap აკავშირებს მფლობელებს, რომლებსაც ერთმანეთის მანქანები უნდათ, გაყიდვის ლოდინის, შემთხვევითი ზარებისა და ორმაგი ვაჭრობის გარეშე.
    - generic [ref=e24]:
      - generic [ref=e25]:
        - heading "რატომ გაცვლა?" [level=2] [ref=e26]
        - paragraph [ref=e27]: "გაყიდვა და ყიდვა ორი ცალკე პროცესია, ორი ვაჭრობა, ორი რისკი და შუაში მანქანის გარეშე დარჩენილი კვირები. გაცვლა ამ ორ ნაბიჯს ერთში აერთიანებს: თავიდანვე ხედავ, ვის უნდა შენი მანქანა, რას გთავაზობს სანაცვლოდ და რა თანხის სხვაობაზეა საუბარი."
      - generic [ref=e28]:
        - heading "როგორ მუშაობს" [level=2] [ref=e29]
        - paragraph [ref=e30]: დაამატებ მანქანას, მიუთითებ რა გინდა სანაცვლოდ და რა სხვაობას ელოდები. მატჩი გაჩვენებს მფლობელებს, რომლებიც სწორედ შენს მანქანას ეძებენ, პირობები ბარათზევე ჩანს, ამიტომ ზარი მხოლოდ საქმეზეა.
      - generic [ref=e31]:
        - heading "ნდობა" [level=2] [ref=e32]
        - paragraph [ref=e33]: "მფლობელები ნომრით დასტურდებიან, პირობები კი გამჭვირვალეა: რას ეძებს მეორე მხარე და რა სხვაობას ითხოვს ან გთავაზობს, წინასწარ იცი. შეთავაზება სტრუქტურირებულია და არა შემთხვევითი მიმოწერა."
      - generic [ref=e34]:
        - heading "კონტაქტი" [level=2] [ref=e35]
        - paragraph [ref=e36]:
          - text: "კითხვა ან უკუკავშირი გაქვს? მოგვწერე:"
          - link "hello@autoswap.ge" [ref=e37] [cursor=pointer]:
            - /url: mailto:hello@autoswap.ge
    - generic [ref=e39]:
      - paragraph [ref=e40]: შენი მანქანა შეიძლება უკვე ვიღაცას უნდა, განცხადება ორ წუთში ემატება.
      - link "დაამატე მანქანა" [ref=e41] [cursor=pointer]:
        - /url: /sell
  - navigation "მთავარი ნავიგაცია" [ref=e44]:
    - link "მთავარი" [ref=e45] [cursor=pointer]:
      - /url: /
    - link "გაცვლები" [ref=e51] [cursor=pointer]:
      - /url: /cars
    - link "დამატება" [ref=e57] [cursor=pointer]:
      - /url: /sell
    - link "შეთავაზებები" [ref=e61] [cursor=pointer]:
      - /url: /account?tab=offers
    - link "პროფილი" [ref=e69] [cursor=pointer]:
      - /url: /account
  - contentinfo [ref=e75]:
    - generic [ref=e76]:
      - generic [ref=e77]:
        - generic [ref=e78]: autoswap
        - paragraph [ref=e86]: რეალური გაცვლები რეალურ მფლობელებს შორის.
      - navigation "ფუტერის ნავიგაცია" [ref=e87]:
        - link "გაცვლები" [ref=e88] [cursor=pointer]:
          - /url: /cars
        - link "განცხადების დამატება" [ref=e89] [cursor=pointer]:
          - /url: /sell
        - link "ჩვენ შესახებ" [ref=e90] [cursor=pointer]:
          - /url: /about
        - link "წესები" [ref=e91] [cursor=pointer]:
          - /url: /terms
        - link "კონფიდენციალურობა" [ref=e92] [cursor=pointer]:
          - /url: /privacy
        - link "კონტაქტი" [ref=e93] [cursor=pointer]:
          - /url: /about#contact
    - generic [ref=e94]: © 2026 AutoSwap · ყველა უფლება დაცულია
```
