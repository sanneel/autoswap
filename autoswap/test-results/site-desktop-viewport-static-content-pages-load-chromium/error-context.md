...
- Name: site.spec.ts >> desktop viewport >> static content pages load
...
- generic [ref=e2]:
  ...
  - main [ref=e25]:
    - region [ref=e26]:
      - generic [ref=e27]:
        - heading "გაცვალე მანქანა გაყიდვის გარეშე" [level=1] [ref=e28]
        - paragraph [ref=e29]: AutoSwap აკავშირებს მფლობელებს, რომლებსაც ერთმანეთის მანქანები უნდათ, გაყიდვის ლოდინის, შემთხვევითი ზარებისა და ორმაგი ვაჭრობის გარეშე.
    - generic [ref=e30]:
      - generic [ref=e31]:
        - heading "რატომ გაცვლა?" [level=2] [ref=e32]
        - paragraph [ref=e33]: "გაყიდვა და ყიდვა ორი ცალკე პროცესია, ორი ვაჭრობა, ორი რისკი და შუაში მანქანის გარეშე დარჩენილი კვირები. გაცვლა ამ ორ ნაბიჯს ერთში აერთიანებს: თავიდანვე ხედავ, ვის უნდა შენი მანქანა, რას გთავაზობს სანაცვლოდ და რა თანხის სხვაობაზეა საუბარი."
      - generic [ref=e34]:
        - heading "როგორ მუშაობს" [level=2] [ref=e35]
        - paragraph [ref=e36]: დაამატებ მანქანას, მიუთითებ რა გინდა სანაცვლოდ და რა სხვაობას ელოდები. მატჩი გაჩვენებს მფლობელებს, რომლებიც სწორედ შენს მანქანას ეძებენ, პირობები ბარათზევე ჩანს, ამიტომ ზარი მხოლოდ საქმეზეა.
      - generic [ref=e37]:
        - heading "ნდობა" [level=2] [ref=e38]
        - paragraph [ref=e39]: "მფლობელები ნომრით დასტურდებიან, პირობები კი გამჭვირვალეა: რას ეძებს მეორე მხარე და რა სხვაობას ითხოვს ან გთავაზობს, წინასწარ იცი. შეთავაზება სტრუქტურირებულია და არა შემთხვევითი მიმოწერა."
      - generic [ref=e40]:
        - heading "კონტაქტი" [level=2] [ref=e41]
        - paragraph [ref=e42]:
          - text: "კითხვა ან უკუკავშირი გაქვს? მოგვწერე:"
          - link "hello@autoswap.ge" [ref=e43] [cursor=pointer]:
            - /url: mailto:hello@autoswap.ge
    - generic [ref=e45]:
      - paragraph [ref=e46]: შენი მანქანა შეიძლება უკვე ვიღაცას უნდა, განცხადება ორ წუთში ემატება.
      - link "დაამატე მანქანა" [ref=e47] [cursor=pointer]:
        - /url: /sell
  - contentinfo [ref=e50]:
    - generic [ref=e51]:
      - generic [ref=e52]:
        - generic [ref=e53]: autoswap
        - paragraph [ref=e61]: რეალური გაცვლები რეალურ მფლობელებს შორის.
      - navigation "ფუტერის ნავიგაცია" [ref=e62]:
        - link "გაცვლები" [ref=e63] [cursor=pointer]:
          - /url: /cars
        - link "•განცხადების დამატება" [ref=e64] [cursor=pointer]:
          - /url: /sell
        - link "•ჩვენ შესახებ" [ref=e65] [cursor=pointer]:
          - /url: /about
        - link "•წესები" [ref=e66] [cursor=pointer]:
          - /url: /terms
        - link "•კონფიდენციალურობა" [ref=e67] [cursor=pointer]:
          - /url: /privacy
        - link "•კონტაქტი" [ref=e68] [cursor=pointer]:
          - /url: /about#contact
    - generic [ref=e69]: © 2026 AutoSwap · ყველა უფლება დაცულია
```
